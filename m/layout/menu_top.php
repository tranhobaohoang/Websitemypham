...
<ul>
	...
	<li id="li-km"><a href="khuyen-mai.html" <?php if($com=="khuyen-mai") echo 'class="active"'; ?> title="Khuyến mãi">Khuyến mãi <i class="fa fa-angle-down"></i></a></li>
	...
	<li class="li-giohang"><a title="Giỏ Hàng" href="gio-hang.html"><img src="assets/images/ic3.png"></a></li>
</ul>
