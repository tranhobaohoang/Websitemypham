<?php
	...
	if($set_level>0){
		function get_main_list(){
			...
			$str.='<label>Danh mục dịch vụ</label>
				<div class="formRight">
					<div class="selector">
...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        ...
        <li><a href="default.php?com=product&act=man&type=<?=$_REQUEST["type"]?>"><span>dịch vụ</span></a></li>
	...
	<div class="widget">
		...
		<div id="info" class="tab_content">
			...
			<div class="formRow">
				...
				<div class="formRight">
					<input type="text" name="masp" title="Nhập mã sản phẩm" id="price" class="tipS" value="<?=@$item['masp']?>" />
				</div>
				<div class="clear"></div>
			</div>
			<div class="formRow">
			...
			<div class="formRow">
				<label>Giá KM</label>
				<div class="formRight">
					<input type="text" name="giakm" title="Nhập giá km" id="price" class="tipS" value="<?=@$item['giakm']?>" />
				</div>
				<div class="clear"></div>
			</div>
			<div class="formRow">
				...
				<div class="formRight">
					<input type="text" name="dung_tich" title="Nhập dung tích" id="price" class="tipS" value="<?=@$item['dung_tich']?>" />
				</div>
				<div class="clear"></div>
			</div>
			<div class="formRow">
				...
				<div class="formRight">
					<input type="text" name="dong_sp" title="Nhập dòng sản phẩm" id="price" class="tipS" value="<?=@$item['dong_sp']?>" />
				</div>
				<div class="clear"></div>
			</div>
			<div class="formRow">
				...
				<div class="formRight">
					<input type="text" name="thuong_hieu" title="Nhập thương hiệu" id="price" class="tipS" value="<?=@$item['thuong_hieu']?>" />
				</div>
				<div class="clear"></div>
			</div>
			<div class="formRow">
				...
				<div class="formRight">
					<input type="text" name="noi_sx" title="Nhập nơi sản xuất" id="price" class="tipS" value="<?=@$item['noi_sx']?>" />
				</div>
				<div class="clear"></div>
			</div>
			<div class="formRow">
			...
			<div class="formRow">
				...
				<div class="formRight">
					<input type="text" class="tipS" value="<?=isset($item['stt'])?$item['stt']:1?>" name="stt" style="width:20px; text-align:center;" onkeypress="return OnlyNumber(event)" original-title="Số thứ tự của dịch vụ, chỉ nhập số">
				</div>
				<div class="clear"></div>
			</div>
			<div class="formRow">
		...
		<div id="content_lang_<?=$key?>" class="tab_content">        
			...
			<div class="formRow">
				<label>Từ khóa</label>
				<div class="formRight">
					<input type="text" value="<?=@$item['keywords_'.$key]?>" name="keywords_<?=$key?>" title="Từ khóa chính cho dịch vụ" class="tipS" />
				</div>
				<div class="clear"></div>
			</div>
