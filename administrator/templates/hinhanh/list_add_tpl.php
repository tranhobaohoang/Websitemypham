...
<form name="frm" method="post" action="default.php?com=img&act=save_list" enctype="multipart/form-data" class="nhaplieu">	    
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='default.php?com=img&act=man_list'" class="btn" />
</form>