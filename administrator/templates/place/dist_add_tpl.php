...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="default.php?com=place&act=mam_province"><span>Quận huyện</span></a></li>
...
<form name="supplier" id="validate" class="form" action="default.php?com=place&act=save_province&curPage=<?=$_REQUEST['curPage']?>" method="post" enctype="multipart/form-data">
	<div class="widget">
