...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="default.php?com=place&act=mam_street"><span>Đường</span></a></li>
...
<form name="supplier" id="validate" class="form" action="default.php?com=place&act=save_street&curPage=<?=$_REQUEST['curPage']?>" method="post" enctype="multipart/form-data">
	<div class="widget">
