<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="default.php?com=user&act=admin_edit"><span>Thông tin tài khoản</span></a></li>
...
<form name="supplier" id="validate" class="form" action="default.php?com=user&act=admin_edit" method="post" enctype="multipart/form-data">	        
    <div class="widget">
