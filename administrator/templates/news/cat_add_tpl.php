...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        ...
        <li><a href="default.php?com=news&act=man_cat&type=<?=$_REQUEST["type"]?>"><span>Danh mục</span></a></li>
        <li class="current"><a href="#" onclick="return false;">Thêm</a></li>
        </ul>
        <div class="clear"></div>
    </div>
</div>
<form name="supplier" id="validate" class="form" action="default.php?com=news&act=save_cat&type=<?=$_REQUEST["type"]?>&curPage=<?=$_REQUEST['curPage']?>" method="post" enctype="multipart/form-data">
	<div class="widget">
