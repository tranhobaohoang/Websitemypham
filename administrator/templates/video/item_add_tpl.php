<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="default.php?com=video&act=mam"><span>Video</span></a></li>
...
<form name="supplier" id="validate" class="form" action="default.php?com=video&act=save&curPage=<?=$_REQUEST['curPage']?>" method="post" enctype="multipart/form-data">
     ...
     <div class="widget">
       ...
       <div id="info" class="tab_content">
          <input type="hidden" name="id" id="id_this_video" value="<?=@$item['id']?>" />
       ...
       <div id="content_lang_<?=$key?>" class="tab_content">        
            ...
            <div class="formRight">
                <input type="text" name="ten_<?=$key?>" title="Nhập tên Video" id="ten_<?=$key?>" class="tipS" value="<?=@$item['ten_'.$key]?>" />
            </div>
            <div class="clear"></div>
        </div>  
