...
<form name="frm" method="post" action="default.php?com=thuonghieu&act=save_photo&id=<?= $_REQUEST['id']; ?>&id_photo=<?= $_REQUEST['id_photo'] ?>" enctype="multipart/form-data" class="nhaplieu">
    ...
    <input type="button" value="Thoát" onclick="javascript:window.location = 'default.php?com=thuonghieu&act=man_photo&id_photo=<?=$_REQUEST["id_photo"]?>'" class="btn" />
</form>