...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        ...
        <li><a href="default.php?com=thuonghieu&act=man_photo&type=<?=$_REQUEST["type"]?>"><span>Hình ảnh</span></a></li>
...
<form name="supplier" id="validate" class="form" action="default.php?com=thuonghieu&act=save_photo&type=<?=$_REQUEST["type"]?>&curPage=<?=$_REQUEST['curPage']?>" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div id="info" class="tab_content">
			...
			<div class="formRow">
				...
				<div class="formRight">
					...
					<!--<a title="Xoá ảnh" href="default.php?com=thuonghieu&act=delete_img&id=<?=@$item['id']?>">Xoá ảnh</a>-->
					<br>
					<?php }?>
