...
<div class="wrapper">
<form name="supplier" id="validate" class="form" action="default.php" method="get" enctype="multipart/form-data">

<div class="widget">
   <div class="title"><h6>Chào mừng bạn đến với Administrator - HỆ THỐNG QUẢN TRỊ NỘI DUNG WEBSITE NapieSkin</span></a></h6><div class="clear"></div></div>
   <p>Nếu bạn có thắc mắc trong quá trình sử dụng, xin vui lòng gởi mail về địa chỉ <strong><a href="mailto:tranhobaohoang@gmail.com">tranhobaohoang@gmail.com</a></strong></p>
