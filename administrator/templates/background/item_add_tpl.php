<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
            <li><a href="index.php?com=background&act=capnhat<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>Hình ảnh</span></a></li>
    ...
    <div class="widget">
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                ...
                <a title="Xoá ảnh" href="index.php?com=background&act=delete_img&id=<?=@$item['id']?>">Xoá ảnh</a>
            </div>
            <div class="clear"></div>                       
        </div>
        <?php }?>        
