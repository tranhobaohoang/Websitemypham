...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="default.php?com=member&act=man"><span>Danh sách thành viên</span></a></li>
...
<form name="supplier" id="validate" class="form" action="default.php?com=member&act=save" method="post" enctype="multipart/form-data">	        
    <div class="widget">
