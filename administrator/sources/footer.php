...
function save_gioithieu() {
    ...
    if (empty($_POST))
        transfer("Không nhận được dữ liệu", "default.php?com=footer&act=capnhat");
	...
	$data['chinhanh_vi'] = ($_POST['chinhanh_vi']);
    $data['chinhanh_en'] = ($_POST['chinhanh_en']);
    ...
    $d->setWhere('id', '4');
    if ($d->update($data))
        transfer("Dữ liệu được cập nhật", "default.php?com=footer&act=capnhat");
    else
        transfer("Cập nhật dữ liệu bị lỗi", "default.php?com=footer&act=capnhat");
}
