...
function get_citys(){
	...
	if(!empty($_POST)){
		...
		if($multi=='show'){
			...
			redirect("default.php?com=place&act=man_city");			
		}
	...
	$url_link='default.php?com=place&act=man_city';		
...
function get_city(){
	...
	if(!$id)
		transfer("Không nhận được dữ liệu", "default.php?com=place&act=man_city");	
	$sql = "select * from #_place_city where id='".$id."'";
	$d->query($sql);
	if($d->num_rows()==0) transfer("Dữ liệu không có thực", "default.php?com=place&act=man_city");
	$item = $d->fetch_array();	
...
function save_city(){
	global $d;	
	if(empty($_POST)) transfer("Không nhận được dữ liệu", "default.php?com=place&act=man_city");
	...
	if($id){
		...
		$d->setWhere('id', $id);
		if($d->update($data)){						
			redirect("default.php?com=place&act=man_city&curPage=".$_REQUEST['curPage']."");
		}else
			transfer("Cập nhật dữ liệu bị lỗi", "default.php?com=place&act=man_city");
	}else{
		...
		{		
			...
			transfer("Lưu dữ liệu bị lỗi", "default.php?com=place&act=man_city");
	}
}
...
function delete_city(){
	...
	if(isset($_GET['id'])){
		...
		if($d->query($sql))
			redirect("default.php?com=place&act=man_city".$id_catt."");
		else
			transfer("Xóa dữ liệu bị lỗi", "default.php?com=place&act=man_city");
	}else transfer("Không nhận được dữ liệu", "default.php?com=place&act=man_city");
}
#====================================
function get_dists(){
	global $d, $items, $url_link,$totalRows , $pageSize, $offset;
	if(!empty($_POST)){
		...
		if($multi=='show'){
			...
			redirect("default.php?com=place&act=man_dist");			
		}
	...
	$d->query($sql);
	$items = $d->result_array();	
	$url_link='default.php?com=place&act=man_dist';		
...
function get_dist(){
	...
	$id = isset($_GET['id']) ? themdau($_GET['id']) : "";
	if(!$id)
		transfer("Không nhận được dữ liệu", "default.php?com=place&act=man_dist");	
	$sql = "select * from #_place_dist where id='".$id."'";
	$d->query($sql);
	if($d->num_rows()==0) transfer("Dữ liệu không có thực", "default.php?com=place&act=man_dist");
	$item = $d->fetch_array();	
...
function save_dist(){
	global $d;	
	if(empty($_POST)) transfer("Không nhận được dữ liệu", "default.php?com=place&act=man_dist");
	$id = isset($_POST['id']) ? themdau($_POST['id']) : "";
	...
	if($id){
		...
		$d->setWhere('id', $id);
		if($d->update($data)){						
			redirect("default.php?com=place&act=man_dist&curPage=".$_REQUEST['curPage']."");
		}else
			transfer("Cập nhật dữ liệu bị lỗi", "default.php?com=place&act=man_dist");
	}else{
		...
		{		
			...
			transfer("Lưu dữ liệu bị lỗi", "default.php?com=place&act=man_dist");
	}
}
...
function delete_dist(){
	...
	if(isset($_GET['id'])){
		...
		if($d->query($sql))
			redirect("default.php?com=place&act=man_dist".$id_catt."");
		else
			transfer("Xóa dữ liệu bị lỗi", "default.php?com=place&act=man_dist");
	}else transfer("Không nhận được dữ liệu", "default.php?com=place&act=man_dist");
}
#====================================
function get_wards(){
	global $d, $items, $url_link,$totalRows , $pageSize, $offset;
	if(!empty($_POST)){
		...
		if($multi=='show'){
			...
			redirect("default.php?com=place&act=man_ward");			
		}
	...
	$d->query($sql);
	$items = $d->result_array();	
	$url_link='default.php?com=place&act=man_ward';		
...
function get_ward(){
	...
	$id = isset($_GET['id']) ? themdau($_GET['id']) : "";
	if(!$id)
		transfer("Không nhận được dữ liệu", "default.php?com=place&act=man_ward");	
	$sql = "select * from #_place_ward where id='".$id."'";
	$d->query($sql);
	if($d->num_rows()==0) transfer("Dữ liệu không có thực", "default.php?com=place&act=man_ward");
	$item = $d->fetch_array();	
...
function save_ward(){
	global $d;	
	if(empty($_POST)) transfer("Không nhận được dữ liệu", "default.php?com=place&act=man_ward");
	$id = isset($_POST['id']) ? themdau($_POST['id']) : "";
	...
	if($id){
		...
		$d->setWhere('id', $id);
		if($d->update($data)){						
			redirect("default.php?com=place&act=man_ward&curPage=".$_REQUEST['curPage']."");
		}else
			transfer("Cập nhật dữ liệu bị lỗi", "default.php?com=place&act=man_ward");
	}else{
		...
		{		
			...
			transfer("Lưu dữ liệu bị lỗi", "default.php?com=place&act=man_ward");
	}
}
...
function delete_ward(){
	...
	if(isset($_GET['id'])){
		...
		if($d->query($sql))
			redirect("default.php?com=place&act=man_ward".$id_catt."");
		else
			transfer("Xóa dữ liệu bị lỗi", "default.php?com=place&act=man_ward");
	}else transfer("Không nhận được dữ liệu", "default.php?com=place&act=man_ward");
}
#====================================
function get_streets(){
	...
	if(!empty($_POST)){
		...
		if($multi=='show'){
			...
			redirect("default.php?com=place&act=man_street");			
		}
	...
	$d->query($sql);
	$items = $d->result_array();	
	$url_link='default.php?com=place&act=man_street';		
...
function get_street(){
	...
	$id = isset($_GET['id']) ? themdau($_GET['id']) : "";
	if(!$id)
		transfer("Không nhận được dữ liệu", "default.php?com=place&act=man_street");	
	$sql = "select * from #_place_street where id='".$id."'";
	$d->query($sql);
	if($d->num_rows()==0) transfer("Dữ liệu không có thực", "default.php?com=place&act=man_street");
	$item = $d->fetch_array();	
...
function save_street(){
	global $d;	
	if(empty($_POST)) transfer("Không nhận được dữ liệu", "default.php?com=place&act=man_street");
	$id = isset($_POST['id']) ? themdau($_POST['id']) : "";
	...
	if($id){
		...
		$d->setWhere('id', $id);
		if($d->update($data)){						
			redirect("default.php?com=place&act=man_street&curPage=".$_REQUEST['curPage']."");
		}else
			transfer("Cập nhật dữ liệu bị lỗi", "default.php?com=place&act=man_street");
	}else{
		...
		{		
			...
			transfer("Lưu dữ liệu bị lỗi", "default.php?com=place&act=man_street");
	}
}
...
function delete_street(){
	...
	if(isset($_GET['id'])){
		...
		if($d->query($sql))
			redirect("default.php?com=place&act=man_street".$id_catt."");
		else
			transfer("Xóa dữ liệu bị lỗi", "default.php?com=place&act=man_street");
	}else transfer("Không nhận được dữ liệu", "default.php?com=place&act=man_street");
}
?>