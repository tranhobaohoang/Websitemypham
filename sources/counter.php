...
if ($s_today)
    $counter .= '<li class="online">' . $today . ': <strong>' . $today_visitors . '</strong></li>';
if ($s_yesterday)
    $counter .= '<li class="guest">' . $yesterday . ': <strong>' . $yesterday_visitors . '</strong></li>';

if ($s_week)
    $counter .= '<li class="page">' . $x_week . ': <strong>' . $week_visitors . '</strong></li>';
if ($s_month)
    $counter .= '<li class="month">' . $x_month . ': <strong>' . $month_visitors . '</strong></li>';
if ($s_all)
    $counter .= '<li class="statistics">' . $all . ': <strong>' . $all_visitors . '</strong></li>';
?> 