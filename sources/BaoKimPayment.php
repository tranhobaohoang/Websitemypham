...
// Mã merchante site 
private $merchant_id = $row_setting['merchant_bk']; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
// Mật khẩu bảo mật
private $secure_pass = $row_setting['pass_bk']; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
